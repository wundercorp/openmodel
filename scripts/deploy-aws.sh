...
export_terraform_variables() {
  ...
  export TF_VAR_hyperscaler_subjects="$OPENMODEL_HYPERSCALER_SUBJECTS"
  export TF_VAR_capacity_heartbeat_max_age_seconds="$OPENMODEL_CAPACITY_HEARTBEAT_MAX_AGE_SECONDS"
  export TF_VAR_capacity_assignment_timeout_seconds="$OPENMODEL_CAPACITY_ASSIGNMENT_TIMEOUT_SECONDS"
  export TF_VAR_capacity_earnings_hold_seconds="$OPENMODEL_CAPACITY_EARNINGS_HOLD_SECONDS"
  export TF_VAR_capacity_minimum_payout_amount="$OPENMODEL_CAPACITY_MINIMUM_PAYOUT_AMOUNT"
  export TF_VAR_capacity_platform_fee_bps="$OPENMODEL_CAPACITY_PLATFORM_FEE_BPS"
