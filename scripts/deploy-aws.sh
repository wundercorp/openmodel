...
set_default_configuration() {
  ...
  OPENMODEL_AWS_ACCOUNT_ID="${OPENMODEL_AWS_ACCOUNT_ID:-668076964296}"
  OPENMODEL_ROUTE53_ZONE_ID="${OPENMODEL_ROUTE53_ZONE_ID:-Z00830633ZJTPIDY86OC}"
  OPENMODEL_ROUTE53_ZONE_NAME="${OPENMODEL_ROUTE53_ZONE_NAME:-openmodel.sh}"
  OPENMODEL_ROUTE53_EXPECTED_NAME_SERVERS="${OPENMODEL_ROUTE53_EXPECTED_NAME_SERVERS:-ns-849.awsdns-42.net,ns-1053.awsdns-03.org,ns-1647.awsdns-13.co.uk,ns-300.awsdns-37.com}"
