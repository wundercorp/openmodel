...
set_default_configuration() {
  ...
  OPENMODEL_HYPERSCALER_SUBJECTS="${OPENMODEL_HYPERSCALER_SUBJECTS:-}"
  OPENMODEL_CAPACITY_HEARTBEAT_MAX_AGE_SECONDS="${OPENMODEL_CAPACITY_HEARTBEAT_MAX_AGE_SECONDS:-120}"
  OPENMODEL_CAPACITY_ASSIGNMENT_TIMEOUT_SECONDS="${OPENMODEL_CAPACITY_ASSIGNMENT_TIMEOUT_SECONDS:-300}"
  OPENMODEL_CAPACITY_EARNINGS_HOLD_SECONDS="${OPENMODEL_CAPACITY_EARNINGS_HOLD_SECONDS:-604800}"
  OPENMODEL_CAPACITY_MINIMUM_PAYOUT_AMOUNT="${OPENMODEL_CAPACITY_MINIMUM_PAYOUT_AMOUNT:-25}"
  OPENMODEL_CAPACITY_PLATFORM_FEE_BPS="${OPENMODEL_CAPACITY_PLATFORM_FEE_BPS:-1000}"
  OPENMODEL_CAPACITY_ALLOW_EVENTUALLY_CONSISTENT_ALLOCATIONS="${OPENMODEL_CAPACITY_ALLOW_EVENTUALLY_CONSISTENT_ALLOCATIONS:-false}"
...
write_worker_configuration() {
  ...
  OPENMODEL_GENERATED_HYPERSCALER_SUBJECTS="$OPENMODEL_HYPERSCALER_SUBJECTS" \
  OPENMODEL_GENERATED_CAPACITY_HEARTBEAT_MAX_AGE_SECONDS="$OPENMODEL_CAPACITY_HEARTBEAT_MAX_AGE_SECONDS" \
  OPENMODEL_GENERATED_CAPACITY_ASSIGNMENT_TIMEOUT_SECONDS="$OPENMODEL_CAPACITY_ASSIGNMENT_TIMEOUT_SECONDS" \
  OPENMODEL_GENERATED_CAPACITY_EARNINGS_HOLD_SECONDS="$OPENMODEL_CAPACITY_EARNINGS_HOLD_SECONDS" \
  OPENMODEL_GENERATED_CAPACITY_MINIMUM_PAYOUT_AMOUNT="$OPENMODEL_CAPACITY_MINIMUM_PAYOUT_AMOUNT" \
  OPENMODEL_GENERATED_CAPACITY_PLATFORM_FEE_BPS="$OPENMODEL_CAPACITY_PLATFORM_FEE_BPS" \
  OPENMODEL_GENERATED_CAPACITY_ALLOW_EVENTUALLY_CONSISTENT_ALLOCATIONS="$OPENMODEL_CAPACITY_ALLOW_EVENTUALLY_CONSISTENT_ALLOCATIONS" \
...
const configuration = {
  ...
  vars: {
    ...
    HYPERSCALER_SUBJECTS: process.env.OPENMODEL_GENERATED_HYPERSCALER_SUBJECTS,
    CAPACITY_HEARTBEAT_MAX_AGE_SECONDS: process.env.OPENMODEL_GENERATED_CAPACITY_HEARTBEAT_MAX_AGE_SECONDS,
    CAPACITY_ASSIGNMENT_TIMEOUT_SECONDS: process.env.OPENMODEL_GENERATED_CAPACITY_ASSIGNMENT_TIMEOUT_SECONDS,
    CAPACITY_EARNINGS_HOLD_SECONDS: process.env.OPENMODEL_GENERATED_CAPACITY_EARNINGS_HOLD_SECONDS,
    CAPACITY_MINIMUM_PAYOUT_AMOUNT: process.env.OPENMODEL_GENERATED_CAPACITY_MINIMUM_PAYOUT_AMOUNT,
    CAPACITY_PLATFORM_FEE_BPS: process.env.OPENMODEL_GENERATED_CAPACITY_PLATFORM_FEE_BPS,
    CAPACITY_ALLOW_EVENTUALLY_CONSISTENT_ALLOCATIONS: process.env.OPENMODEL_GENERATED_CAPACITY_ALLOW_EVENTUALLY_CONSISTENT_ALLOCATIONS
  },
  kv_namespaces: [
    {
