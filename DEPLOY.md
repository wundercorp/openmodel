...
- AWS account: `668076964296`
- Hosted zone: `Z00830633ZJTPIDY86OC`
- Assigned name servers: `ns-849.awsdns-42.net`, `ns-1053.awsdns-03.org`, `ns-1647.awsdns-13.co.uk`, and `ns-300.awsdns-37.com`
...
The returned account must be `668076964296`.
...
OPENMODEL_AWS_ACCOUNT_ID="668076964296"
OPENMODEL_ROUTE53_ZONE_ID="Z00830633ZJTPIDY86OC"
OPENMODEL_ROUTE53_ZONE_NAME="openmodel.sh"
OPENMODEL_ROUTE53_EXPECTED_NAME_SERVERS="ns-849.awsdns-42.net,ns-1053.awsdns-03.org,ns-1647.awsdns-13.co.uk,ns-300.awsdns-37.com"
```
...
```text
openmodel-terraform-state-668076964296
```
...
- ACM certificates
- Route 53 records in hosted zone `Z00830633ZJTPIDY86OC`
...
aws route53 list-resource-record-sets \
  --hosted-zone-id Z00830633ZJTPIDY86OC \
  --profile wundercorp
```
